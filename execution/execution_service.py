...
class ExecutionService:
    ...
    def close(self, symbol=None):
        if symbol and hasattr(self.core, "STATE") and self.core.STATE.get("current_symbol") != symbol:
            # The portfolio layer normally activates the symbol.  If this boundary
            # is used directly, refuse a cross-symbol close rather than touching
            # whichever position happens to be globally active.
            return False
