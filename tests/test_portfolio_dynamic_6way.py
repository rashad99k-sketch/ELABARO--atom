...
class DynamicSixPositionRealEngineTest(_PortfolioEngineTestCase):
    ...
    SIX = [
        _cand("BTC/USDT:USDT", "CRYPTO", 60000.0),                 # technical
        _cand("ETH/USDT:USDT", "CRYPTO", 3000.0),                  # technical crash -> real SL
        _cand("US500/USDT:USDT", "INDEX", 5000.0),                 # technical
        _cand("USTECH/USDT:USDT", "INDEX", 17000.0, side="SELL"),  # technical
        _cand("WTI", "OIL", 75.0),                                 # technical crash -> real SL
        _cand("SOL/USDT:USDT", "NEWS", 150.0),                   # independent NEWS slot
    ]
    ROTATION = [
        _cand("SOL/USDT:USDT", "CRYPTO", 150.0),
        _cand("BRENT", "OIL", 80.0),
    ]
    ...
    def test_six_simultaneous_dynamic_lifecycle(self):
        ...
        # --- Capacity: five technical + one NEWS = exactly six; 7th refused ---
        ...
        for sym, mult in (("ETH/USDT:USDT", 0.97), ("WTI", 0.97),
                          ...
                          ("SOL/USDT:USDT", 1.004), ("USTECH/USDT:USDT", 0.996)):
        ...
        # After two technical exits, only one technical slot is reusable:
        # the sixth seat remains reserved for the independent NEWS slot.
...
class AllocatorGatesOnLivePortfolioTest(_PortfolioEngineTestCase):
    ...
    def _open_six(self):
        ...
        six = [
            ...
            _cand("SOL/USDT:USDT", "NEWS", 150.0),
        ]
    ...
    def test_allocator_explains_every_rejected_slot_at_capacity(self):
        ...
        self.assertEqual(by["TSLA"].reason, "NEWS_CAP")
        self.assertFalse(by["NVDA"].allowed)
        self.assertEqual(by["NVDA"].reason, "NEWS_CAP")
