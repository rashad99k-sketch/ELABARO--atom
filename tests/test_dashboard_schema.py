...
CANONICAL_KEYS = {
    ...
    "dynamic_tp1", "dynamic_tp2", "last_update_ts", "profit_execution",
    "roi_pct", "price_move_pct", "initial_margin", "profit_stage",
    "tp1_progress_pct", "tp2_progress_pct", "tp1_close_pct", "tp2_close_pct",
    "remaining_pct", "runner_active", "runner_health", "management_action",
    "management_reason", "profit_protection", "news_context",
}
...
class EngineCanonicalPayloadTest(unittest.TestCase):
    ...
    def _open_state(self):
        ...
        e.STATE.update({
            ...
            "margin": 10.0, "unrealized_pnl_usdt": 2.5, "profit_execution": {
                "stage": "TP1", "mode": "PAPER", "verified": True,
            },
        })
