...
class CorrectionManagementTest(unittest.TestCase):
    ...
    def test_trend_correction_protects_before_canonical_tp1(self):
        ...
        self.assertTrue(E.STATE.get("dynamic_partial_done"))
        self.assertEqual(E.STATE.get("profit_protection_reason"), "EARLY_PROFIT_PROTECTION_WAIT_TP1")  # partial banked
